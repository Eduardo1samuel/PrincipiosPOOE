...
public class GestorAcademico implements ServiciosAcademicosI {
    ...
    @Override
    public void inscribirEstudianteCurso(Estudiante estudiante, int idCurso) throws EstudianteInscritoException {
        ...
        if (curso != null) {
            ...
            if (inscritos.contains(estudiante)) {
                throw new EstudianteInscritoException("El estudiante ya está inscrito en el curso ");
            }
    ...
    @Override
    public void desinscribirEstudianteCurso(int idEstudiante, int idCurso) throws EstudianteNoInscritoException {
        Curso curso = obtenerCursoPorId(idCurso);
        if (curso != null) {
            ArrayList<Estudiante> inscritos = estudiantesPorCurso.get(curso);
            ...
            if (inscritos.contains(estudiante)) {
                ...
                throw new EstudianteNoInscritoException("El estudiante no está inscrito en el curso ");
            }
        }
    }
